    ...
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        var timestamp = Date.now();
          var body = '<ul class="nav nav-pills">' +
                   '  <li class="nav-item active"><a  class="nav-link" href="#note-imageAttributes' + timestamp + '" data-toggle="tab">' + lang.imageAttributes.tabImage + '</a></li>' +
        ...
        if (options.imageAttributes.disableUpload == false) {
            body += '  <li><a class="nav-link" href="#note-imageAttributes-upload' + timestamp + '" data-toggle="tab">' + lang.imageAttributes.tabUpload + '</a></li>';
        }
        body +=    '</ul>' +
